...
const plans = [
  // ... your plans unchanged ...
  {
    ...
    color: '#d0f0f5',
    features: [
      { text: 'Publicējiet 1 pazudušu, atrastu mājdzīvnieku' },
      { text: 'Saņemiet reāllaika paziņojumus' },
      { text: 'Standarta sludinājuma laiks līdz 30 dienām' },
      { text: 'AI asistents un mākslīgā intelekta funkcijas' },
      { text: 'Plus punkts karmai ❤️', extra: true },
  ...
  },
  {
    ...
    color: '#e8f6f9',
    features: [
      { text: 'Publicējiet līdz 3 pazudušiem, atrastiem mājdzīvniekiem' },
      { text: 'Saņemiet reāllaika paziņojumus' },
      { text: 'Paplašināts sludinājumu laiks 90 dienām' },
      { text: 'AI asistents un mākslīgā intelekta funkcijas' },
      { text: 'Plus punkts karmai ❤️' },
  ...
  },
  {
    ...
    color: '#e8f6f9',
    features: [
      { text: 'Publicējiet līdz 5 pazudušiem, atrastiem mājdzīvniekiem' },
      { text: 'Saņemiet reāllaika paziņojumus' },
      { text: 'AI asistents un mākslīgā intelekta funkcijas' },
      { text: 'Paplašināts sludinājumu laiks 90 dienām' },
