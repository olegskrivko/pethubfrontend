        ...
        Push Notifications
              ...
              >
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
                  {isSubscribed ? (
                    <>
                      <Button variant="contained" color="error" onClick={unsubscribeUser} startIcon={<CancelIcon />}>
                        Unsubscribe
                      </Button>
                      <Button variant="outlined" startIcon={<SendIcon />} onClick={sendTestNotification}>
