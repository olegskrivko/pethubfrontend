...
const PetAttributes = ({ pet }) => {
  ...
  const attributes = [
    ...
    { icon: <TextureIcon />, label: 'Kažoka raksts', value: pet.pattern_display },
    { icon: <ColorLensIcon />, label: 'Pamatkrāsa', value: pet.primary_color_display },
    { icon: <ColorLensIcon />, label: 'Sekundārā krāsa', value: pet.secondary_color_display },
    { icon: <EventIcon />, label: 'Datums un laiks', value: `${formattedDate}, ${formattedTime}` },
  ];
