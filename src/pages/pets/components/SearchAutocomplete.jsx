    ...
    if (inputValue.length >= 3) {
      ...
      const fetchSuggestions = async () => {
        try {
          ...
          const res = await axios.get(`${API_BASE_URL}/api/pets/?search=${inputValue}&status=${filters.status}&species=${filters.species}&gender=${filters.gender}&size=${filters.size}&pattern=${filters.pattern}&date=${filters.date}&color=${filters.color}`);
