                              ...
                              <Grid  size={{ xs: 12, sm: 12, md: 12, lg: 12 }}>
                                      <FormControl fullWidth variant="outlined">
                                        ...
                                        displayEmpty
                                          ...
                                          disabled={formState.appearance.pattern === ""} // Disable if pattern is ""
                                    ...
                                    <Grid  size={{ xs: 12, sm: 12, md: 12, lg: 12 }}>
                                      <FormControl fullWidth variant="outlined">
                                        ...
                                        <Select
                                          ...
                                          displayEmpty
                                          disabled={formState.appearance.pattern === 1 || formState.appearance.pattern === "" } // Disable if pattern is "1"
