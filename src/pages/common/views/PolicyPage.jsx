...
<Container component="main" maxWidth="lg" >
  ...
  <Typography variant="h4" align="center" sx={{ mb: 5, fontWeight: 800, background: "linear-gradient(60deg, #16477c 0%, #00b5ad 100%)", WebkitBackgroundClip: "text",
    WebkitTextFillColor: "transparent"
   }}> Privātuma, sīkdatņu politika un pakalpojumu noteikumi</Typography>
  <Box sx={{ mb: 3 }}>
   ...
   <Grid container spacing={3}>
        <Grid item xs={12} sm={12} md={12} lg={12}>
          ...
          <Typography paragraph>
            Šie Pakalpojumu sniegšanas noteikumi ("Noteikumi") regulē jūsu lietotnes ("Lietotne"), ko pārvalda mūsu komanda ("mēs", "mūsu" vai "mūsējo"), izmantošanu.
          </Typography>
          ...
          <Typography paragraph>
            Piekļūstot vai izmantojot Lietotni, jūs piekrītat būt saistīts ar šiem Noteikumiem. Ja jūs nepiekrītat kādai no Noteikumu daļām, tad jums nav tiesību piekļūt Lietotnei.
          </Typography>
          ...
          <Typography paragraph>
            Mēs paturam tiesības atjaunināt vai mainīt šos Noteikumus jebkurā laikā bez iepriekšēja brīdinājuma. Izmaiņas stājas spēkā uzreiz pēc to publicēšanas Lietotnē. Jūsu turpmāka Lietotnes izmantošana pēc izmaiņām nozīmē, ka jūs piekrītat izmainītajiem Noteikumiem.
          </Typography>
          ...
          <Typography paragraph>
            Lietotne un tās saturs tiek nodrošināti "kā ir" un "kā pieejams". Mēs nesniedzam nekādas garantijas, izteiktas vai netiešas, par informācijas precizitāti, pietiekamību, uzticamību vai pilnību Lietotnē. Mēs atsakāmies no jebkādas atbildības par jebkādām kļūdām vai izlaidumiem saturā vai par jebkādiem zaudējumiem vai bojājumiem, kas izriet no Lietotnes izmantošanas vai paļaušanās uz tās saturu.
          </Typography>
          ...
          <Typography paragraph>
            Lietotāji ir atbildīgi par sava konta piekļuves datu, tostarp paroli, konfidencialitāti un drošību. Mēs iesakām lietotājiem izveidot spēcīgas, unikālas paroles un izvairīties no vienas un tās pašas paroles izmantošanas vairākiem kontiem.
          </Typography>
          <Typography paragraph>
            Lai gan mēs īstenojam drošības pasākumus, lai aizsargātu lietotāju datus, tostarp paroļu šifrēšanu, mēs nevaram garantēt lietotāju informācijas absolūtu drošību. Lietotāji apzinās un pieņem ar informācijas pārsūtīšanu internetā un tiešsaistes pakalpojumu izmantošanu saistītos riskus.
          </Typography>
          <Typography paragraph>
            Gadījumā, ja notiek drošības pārkāpums vai nesankcionēta piekļuve lietotāju kontiem, mēs nekavējoties informēsim skartos lietotājus un veiksim atbilstošus pasākumus, lai mazinātu pārkāpuma sekas. Tomēr mēs atsakāmies no jebkādas atbildības par jebkādiem zaudējumiem vai bojājumiem, kas radušies nesankcionētas piekļuves lietotāju kontiem dēļ, tostarp, bet ne tikai, datu pārkāpumiem vai nesankcionētai konta piekļuves datu izmantošanai.
          </Typography>
          ...
          <Typography paragraph>
            Lietotnes saturs un materiāli, tostarp, bet neaprobežojoties ar tekstu, attēliem, logotipiem un preču zīmēm, pieder mums vai ir licencēti un ir aizsargāti ar intelektuālā īpašuma likumiem. Jūs nedrīkstat izmantot, reproducēt vai izplatīt jebkādu Lietotnes saturu bez mūsu iepriekšējas rakstiskas piekrišanas.
          </Typography>
          ...
          <Typography paragraph>
            Lietotāji piekrīt neveikt nekādas darbības, kas varētu traucēt vai traucēt Lietotnes vai tās pakalpojumu darbību. Aizliegtas darbības ietver, bet neaprobežojas ar, ļaunprātīgu uzvedību, surogātpasta sūtīšanu, nesankcionētu piekļuvi vai nelikumīgām darbībām.
          </Typography>
          ...
          <Typography paragraph>
            Mēs paturam tiesības izbeigt vai apturēt lietotāju kontus pēc mūsu ieskatiem jebkura iemesla dēļ, tostarp, bet ne tikai, Noteikumu pārkāpumu vai Lietotnes ļaunprātīgas izmantošanas gadījumā.
          </Typography>
          ...
          <Typography paragraph>
            Lietotāji piekrīt atlīdzināt un aizsargāt mūs no jebkādām prasībām, zaudējumiem vai bojājumiem, kas izriet no Lietotnes izmantošanas vai šo Noteikumu pārkāpumiem.
          </Typography>
          ...
          <Typography paragraph>
            Šie Noteikumi tiek regulēti un interpretēti saskaņā ar Latvijas likumiem, neņemot vērā tās tiesību kolīziju principus.
          </Typography>
          ...
          <Typography paragraph>
            Ja jums ir kādi jautājumi vai bažas par šiem Noteikumiem, lūdzu, sazinieties ar mums, izmantojot kontaktinformāciju, kas norādīta mūsu kontaktu lapā.
          </Typography>
  ...
  <Box id="data-protection-policy" ref={(el) => paragraphRefs.current[3] = el} sx={{ mb: 3 }}>
    ...
    <Grid container spacing={3}>
        <Grid item xs={12}>
          <Box sx={{ mb: 3 }}>
            <Typography paragraph sx={{ fontSize: '1rem', lineHeight: 1.6 }}>
              Šī datu aizsardzības politika izskaidro, kā mēs aizsargājam lietotāju personīgo informāciju, kas tiek ievākta caur mūsu tīmekļa vietni un mobilo lietotni (kopīgi sauktas par "Lietotni").
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Typography paragraph sx={{ fontSize: '1rem', lineHeight: 1.6 }}>
              Mēs īstenojam drošības pasākumus, lai aizsargātu jūsu informāciju no nesankcionētas piekļuves, izpaušanas vai izmaiņām. Paroles tiek šifrētas un uzglabātas drošā veidā.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Typography paragraph sx={{ fontSize: '1rem', lineHeight: 1.6 }}>
              Lietotāji var pieprasīt savas informācijas labošanu vai dzēšanu jebkurā laikā. Pēc pieprasījuma dati tiek neatgriezeniski dzēsti.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Typography paragraph sx={{ fontSize: '1rem', lineHeight: 1.6 }}>
              Mēs neizpaužam personas datus trešajām pusēm bez jūsu piekrišanas, izņemot gadījumus, kad tas nepieciešams juridisku prasību izpildei vai pakalpojumu nodrošināšanai.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Typography paragraph sx={{ fontSize: '1rem', lineHeight: 1.6 }}>
              Mēs ievērojam Vispārīgo datu aizsardzības regulu (GDPR), CCPA un citus piemērojamos likumus un noteikumus.
            </Typography>
          </Box>
    ...
    <Typography variant="h4" sx={{ fontWeight: 600, color: "#16477c" }}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={12} md={12} lg={12}>
          ...
          <Typography paragraph>
            Informācija, kas tiek sniegta tīmekļa lietotnē, ir paredzēta tikai vispārīgiem informatīviem nolūkiem. Lai gan mēs cenšamies uzturēt informāciju aktuālu un precīzu, mēs nesniedzam nekādas garantijas, izteiktas vai netiešas, par tīmekļa lietotnes vai tajā esošās informācijas, produktu, pakalpojumu vai saistīto grafiku pilnīgumu, precizitāti, uzticamību, piemērotību vai pieejamību jebkuram mērķim.
          </Typography>

          <Typography paragraph>
            Jebkāda paļaušanās uz šādu informāciju ir tikai jūsu pašu risks. Mēs neuzņemamies atbildību par jebkādiem zaudējumiem vai bojājumiem, tostarp, bez ierobežojumiem, netiešiem vai izrietošiem zaudējumiem vai bojājumiem, vai jebkādiem zaudējumiem vai bojājumiem, kas radušies datu vai peļņas zaudēšanas rezultātā, kas izriet no tīmekļa lietotnes izmantošanas vai saistībā ar to.
          </Typography>

          <Typography paragraph>
            Caur šo tīmekļa lietotni jūs varat izveidot saites uz citām tīmekļa vietnēm, kuras nav mūsu kontrolē. Mēs nekontrolējam šo vietņu dabu, saturu un pieejamību. Jebkuru saišu iekļaušana ne vienmēr nozīmē, ka mēs tās iesakām vai atbalstām tajās izteiktos viedokļus.
          </Typography>

          <Typography paragraph>
            Mēs darām visu iespējamo, lai tīmekļa lietotne darbotos nevainojami. Tomēr mēs neuzņemamies atbildību par to, ja tīmekļa vietne vai lietotne īslaicīgi nav pieejama tehnisku problēmu dēļ, kas ir ārpus mūsu kontroles.
          </Typography>
